          		...
          		<table class="table table-hover">
					  ...
					  <tbody>
					  	...
					  	<?php foreach ($menu as $m): ?>
						      ...
						      <td><?= $m['menu'] ?></td>
						      <td>
						      	<a href="<?= base_url() ?>menu/edit/<?php echo $m['id'] ?>" class="badge badge-success">Edit</a>
						      	<a href="<?= base_url() ?>menu/delete/<?php echo $m['id'] ?>" class="badge badge-danger" onclick="return confirm('Are you sure?')">Delete</a>
						      </td>
						    </tr>
					  	<?php endforeach ?>
					  </tbody>
