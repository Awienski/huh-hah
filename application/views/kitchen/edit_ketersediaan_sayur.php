        ...
        <div class="container-fluid">
          ...
          <div class="row">
          	<div class="col-lg-6">
          		...
          		<form method="post" action="<?= base_url('kitchen/edit_ketersediaan_sayur/'.$sayur['id_barangjual']) ?>">
                <input type="hidden" name="id_barangjual" value="<?= $sayur['id_barangjual'] ?>">
                <div class="form-group">
                   <input name="name" type="text" class="form-control" id="title" placeholder="Name" value="<?= $sayur['nama_barangjual'] ?>" readonly>
                </div>
                ...
                <div class="form-group">
                  ...
                  <input name="stok_lama" type="text" class="form-control" id="stok_lama" value="<?= $sayur['stok'] ?>" readonly>
                </div>
                <div class="form-group">
