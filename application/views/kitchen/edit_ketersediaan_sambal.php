        ...
        <div class="container-fluid">
          ...
          <div class="row">
          	<div class="col-lg-6">
          		...
          		<form method="post" action="<?= base_url('kitchen/edit_ketersediaan_sambal/'.$sambal['id_barangjual']) ?>">
                <input type="hidden" name="id_barangjual" value="<?= $sambal['id_barangjual'] ?>">
                <div class="form-group">
                   <input name="name" type="text" class="form-control" id="name" placeholder="Name" value="<?= $sambal['nama_barangjual'] ?>" readonly>
                </div>
                ...
                <div class="form-group">
                  ...
                  <input name="stok_lama" type="text" class="form-control" id="stok_lama" value="<?= $sambal['stok'] ?>" readonly>
                </div>
                <div class="form-group">
