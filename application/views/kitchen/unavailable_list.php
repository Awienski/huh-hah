			...
			<div class="row">
          	<div class="col-lg-8">
          		...
          		<table class="table table-hover">
					  ...
					  <tbody>
					  	<?php $i = 0 ?>
					  	<?php foreach ($unavailable as $un): ?>
					  		<tr>
						      <th scope="row"><?= $i+=1 ?></th>
						      <td><?= $un['nama_barangjual'] ?></td>
						      <td><?php if ($un['stok'] >= 1) {
						      	echo "<span class='badge badge-success'>Available</span>";
						      }else{
						      	echo "<span class='badge badge-danger'>Unavailable</span>";
						      } ?></td>
						      <td align="center"><?= $un['stok'] ?></td>
						      <td>
						      	<a href="<?= base_url() ?>kitchen/edit_unavailable_list/<?php echo $un['id_barangjual'] ?>" class="badge badge-primary">Update Stok</a>
						      </td>
						    </tr>
					  	<?php endforeach ?>
					  </tbody>
